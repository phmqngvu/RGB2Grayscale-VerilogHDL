...
- All arithmetic in Verilog is implemented using integer and fixed-point operations to ensure synthesizability.
- Brightness adjustment includes saturation logic to clamp output values within \([0, 255]\).
- The project is designed for educational purposes in Digital System Design and HDL-based image processing.
